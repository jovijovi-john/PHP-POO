<?php
    ...
    class Funcionario {
        ...
        function resumirCadFunc(){
            return  $this->__get("nome")." possui ".$this->__get("qntdFilhos")." filhos, trabalha como ".$this->__get("cargo")." ganhando R$ ".$this->__get("salario")." , e seu telefone é ". $this->__get("telefone");
        }
    };
